...
public class Launch 
{
	public static void displayLaunch() // Oui, je pourrais améliorer ça... -- Jack
	{
		...
		System.out.println("|l’éducation, un élu souhaite construire de de nouvelles      |");
		System.out.println("|écoles, modernes, dans la communauté d’agglomération dont il |");
		System.out.println("|est responsable. Durant la campagne électorale, il a promis  |");
		System.out.println("|deux choses :                                                |");
